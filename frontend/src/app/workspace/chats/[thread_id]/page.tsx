    ...
    <ThreadContext.Provider value={{ thread, isMock }}>
      <ChatBox threadId={threadId}>
        <div className="relative flex size-full min-h-0 justify-between">
          <header
            className={cn(
              "absolute top-0 right-0 left-0 z-30 flex h-12 shrink-0 items-center border-b px-4",
              isWelcomeMode
                ? "border-transparent bg-background/0 backdrop-blur-none"
                : "border-[var(--kz-border-soft)] bg-[rgba(11,18,32,0.78)] shadow-xs backdrop-blur",
            )}
          >
