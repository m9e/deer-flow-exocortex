...
export const enUS: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      preferredNameTitle: "What do I call you?",
      preferredNameDescription: "Leave blank to use your Kamiwaza user info.",
      preferredNamePlaceholder: "(default Kamiwaza User Info)",
